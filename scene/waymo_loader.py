...
#         refined_bboxes = []
#         for subdir in ['refined_bbox_0', 'refined_bbox_1', 'refined_bbox_2']:
#             refined_bbox = Image.open(os.path.join(args.source_path, subdir, car_id + '.png'))
#             refined_bbox = refined_bbox.resize((HWs[0][1], HWs[0][0]))
#             refined_bbox = np.array(refined_bbox) > 0
#             refined_bboxes.append(refined_bbox.astype(np.float32))
